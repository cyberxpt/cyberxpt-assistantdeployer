<style>
  ...
  .base-timer__path-remaining {
    stroke-width: 7px; stroke-linecap: round; transform: rotate(90deg);
    transform-origin: center; transition: 1s linear all; fill-rule: nonzero; stroke: currentColor;
  }
...
<script type="module">
  ...
  // ... (checkDeploymentStatus, startDestroyCountdown, extendlab, deployLab, destroyLab, copyToClipboard are same as your snippet) ...
  // Keeping them consistent with your implementation:
  ...
  // DYNAMIC FETCHING OF CREDITS & EXPIRY
