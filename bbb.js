...
// 1. ORIGINAL CSS RESTORED (With resize support)
...
style.textContent = `
  ...
  .resizer {
    ...
    cursor: nwse-resize; z-index: 2147483648; background: transparent;
  }
...
// 2. ORIGINAL HTML STRUCTURE RESTORED (Including Contact Us)
...
// 3. INTERACTION LOGIC (Original drag + Fixed Resize)
...
function startDestroyCountdown(destroyTimeISO, startTimeISO) {
  ...
  const total = (dTime - new Date(startTimeISO).getTime()) / 1000;
